...
//Name: Anthony
//Piece: Pawn
//Description: Can move one square forward, or two squares if on the startingcolumn. Captures forward diagnaolly.
...
//Pre-Condition: Takes into two argument, the board itself alongside thestarting square for the piece. User must click on this piece.
//Post-condition: Returns a list of tiles which the piece we are currentlylooking at controls.
...
//Pre-Condition: Takes in the board itself, alongside the starting square ofthe piece. This piece must be a pawn. User must click on this piece.
//Post-Condition: Will return a list of legal moves, which from the currentpostion the pawn can move to.
