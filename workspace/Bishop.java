...
// Period: 2
// Piece: Bishop
// The bishop moves diagonally, staying on the same colored square throughout theentire game.
// It has infinite range until the end of the board or until there is a piece inthe way (if it is an opposite color piece, it can capture it)
...
if (b[tempRow][tempCol].isOccupied()==false){
    ...
    // Postcondition: Returns an array list of all moves that can be made by the bishopduring its turn, in diagonal directions limited by the edge of the board, its ownpieces, and enemy pieces, which it CAN capture
